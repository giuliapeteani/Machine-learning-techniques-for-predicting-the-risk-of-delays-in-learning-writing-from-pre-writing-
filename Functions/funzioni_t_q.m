...
close all
clc
clearvars -except mat es_iOS_t_q significance es_iOS unity
t_q=4;
iOS=1;
...
featureTQ=[mean_speed, max_speed, std_speed, numero_picchi, varianza_az, varianza_alt, Tsottosoglia,...
          ampiezza_bandaV,ampiezza_primo_picco_v,ampiezza_secondo_picco_v, posizione_primo_picco_v,...
          posizione_secondo_picco_v,energia_10V, ampiezza_bandaP,ampiezza_primo_picco_p,ampiezza_secondo_picco_p,...
          posizione_primo_picco_p, posizione_secondo_picco_p, energia_10P, ampiezza_bandaAZ,ampiezza_primo_picco_az,...
          ampiezza_secondo_picco_az, posizione_primo_picco_az,posizione_secondo_picco_az, energia_10AZ,...
          ampiezza_bandaAL,ampiezza_primo_picco_al,ampiezza_secondo_picco_al, posizione_primo_picco_al,...
          posizione_secondo_picco_al,energia_10AL,R2,RMSE, significant, global_MT, vin, vout, errori];
