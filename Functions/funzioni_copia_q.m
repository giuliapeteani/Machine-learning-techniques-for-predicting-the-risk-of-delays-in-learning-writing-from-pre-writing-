...
std_speed= NaN* ones(size(speedCQ,1),3);
...
featureCQ=[max_speed,mean_speed,std_speed,numero_picchi,varianza_alt,varianza_az,Tsottosoglia,tempo_in_aria,centroide_x,...
    ...
    ampiezza_primo_picco_az, ampiezza_primo_picco_p, ampiezza_primo_picco_v,ampiezza_secondo_picco_al, ...
    ampiezza_secondo_picco_az, ampiezza_secondo_picco_p, ampiezza_secondo_picco_v,energia_10AL, energia_10AZ,...
    energia_10P, energia_10V, posizione_primo_picco_al, posizione_primo_picco_az, posizione_primo_picco_p, ...
    posizione_primo_picco_v,posizione_secondo_picco_v, posizione_secondo_picco_p, posizione_secondo_picco_az,...
    posizione_secondo_picco_al];
